...
try {
    $id = $_GET["id"];
    conectar();
    $sql = "SELECT * FROM tablamujer WHERE id = $id";
    ...
    <body>
        ...
        <div class="container">
            ...
            <form style="max-width: 600px; margin: 0 auto;" enctype="multipart/form-data"
                  action="mujer_procesar.php" method="post">
                <input type="hidden" value="<?= $mujer['id'] ?>" name="id"/>
                <div class="form-floating mb-3 mt-3">
                    <input type="text" value="<?= $mujer['nombre'] ?>"
                           class="form-control" id="nombre" name="nombre">
                    <label for="nombre">Nombre</label>
                </div> 
                <div class="form-floating mb-3 mt-3">
                    <textarea class="form-control" 
                              name="descripcion"><?= $mujer['descripcion'] ?></textarea>
                ...
                <div class="form-floating mb-3 mt-3">
                    <input type="number" value="<?= $mujer['precio'] ?>"
                           class="form-control" id="precio" name="precio" min="0" step="0.01">
                    <label for="precio">Precio</label>
                </div> 
                <div class="form-floating mb-3 mt-3">
                    <input type="number" value="<?= $mujer['cantidad'] ?>"
