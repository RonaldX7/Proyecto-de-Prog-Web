...
try {
    $id = $_GET["id"];
    conectar();
    $sql = "SELECT * FROM tablahombre WHERE id = $id";
    ...
    <body>
        ...
        <div class="container">
            ...
            <form style="max-width: 600px; margin: 0 auto;" enctype="multipart/form-data"
                  action="hombre_procesar.php" method="post">
                <input type="hidden" value="<?= $hombre['id'] ?>" name="id"/>
                <div class="form-floating mb-3 mt-3">
                    <input type="text" value="<?= $hombre['nombre'] ?>"
                           class="form-control" id="nombre" name="nombre">
                    <label for="nombre">Nombre</label>
                </div> 
                <div class="form-floating mb-3 mt-3">
                    <textarea class="form-control" 
                              name="descripcion"><?= $hombre['descripcion'] ?></textarea>
                ...
                <div class="form-floating mb-3 mt-3">
                    <input type="number" value="<?= $hombre['precio'] ?>"
                           class="form-control" id="precio" name="precio" min="0" step="0.01">
                    <label for="precio">Precio</label>
                </div> 
                <div class="form-floating mb-3 mt-3">
                    <input type="number" value="<?= $hombre['cantidad'] ?>"
