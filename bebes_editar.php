...
try {
    $id = $_GET["id"];
    conectar();
    $sql = "SELECT * FROM tablabebes WHERE id = $id";
    ...
    <body>
        ...
        <div class="container">
            ...
            <form style="max-width: 600px; margin: 0 auto;" enctype="multipart/form-data"
                  action="bebes_procesar.php" method="post">
                <input type="hidden" value="<?= $bebes['id'] ?>" name="id"/>
                <div class="form-floating mb-3 mt-3">
                    <input type="text" value="<?= $bebes['nombre'] ?>"
                           class="form-control" id="nombre" name="nombre">
                    <label for="nombre">Nombre</label>
                </div> 
                <div class="form-floating mb-3 mt-3">
                    <textarea class="form-control" 
                              name="descripcion"><?= $bebes['descripcion'] ?></textarea>
                ...
                <div class="form-floating mb-3 mt-3">
                    <input type="number" value="<?= $bebes['precio'] ?>"
                           class="form-control" id="precio" name="precio" min="0" step="0.01">
                    <label for="precio">Precio</label>
                </div> 
                <div class="form-floating mb-3 mt-3">
                    <input type="number" value="<?= $bebes['cantidad'] ?>"
